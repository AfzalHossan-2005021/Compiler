...
func_definition : type_specifier ID LPAREN parameter_list RPAREN compound_statement {
		...
		$$ = new ASTFunctionNode(rule, functionInfo, @$.first_line, @$.last_line);
		$$->addChild($1)->addChild(new ASTLeafNode($2, @2.first_line))->addChild(new ASTLeafNode($3, @3.first_line))->addChild($4)->addChild(new ASTLeafNode($5, @5.first_line))->addChild($6);
		
		// comment out line 174-178 and uncomment the below section to Insert the functions having error in Symbol Table
		// writeLog("func_definition : type_specifier ID LPAREN parameter_list RPAREN compound_statement ");
		// if($4->isError()){
		// 	string errorMsg = "Line# " + to_string(@$.first_line) + ": Syntax error at parameter list of function definition";
		// 	writeError(errorMsg);
	...
	| type_specifier ID LPAREN RPAREN compound_statement {
		...
		$$ = new ASTFunctionNode(rule, functionInfo, @$.first_line, @$.last_line);
		$$->addChild($1)->addChild(new ASTLeafNode($2, @2.first_line))->addChild(new ASTLeafNode($3, @3.first_line))->addChild(new ASTLeafNode($4, @4.first_line))->addChild($5);
...
compound_statement : LCURL subroutine statements RCURL {
		string rule = "compound_statement : LCURL statements RCURL";
		$$ = new ASTInternalNode(rule, @$.first_line, @$.last_line);
		$$->addChild(new ASTLeafNode($1, @1.first_line))->addChild($3)->addChild(new ASTLeafNode($4, @4.first_line));
		writeLog("compound_statement : LCURL statements RCURL  ");
		logFile << symbolTable->PrintAllScopeTable();
		symbolTable->ExitScope();
	}
	| LCURL subroutine RCURL {
		string rule = "compound_statement : LCURL RCURL";
		$$ = new ASTInternalNode(rule, @$.first_line, @$.last_line);
		$$->addChild(new ASTLeafNode($1, @1.first_line))->addChild(new ASTLeafNode($3, @3.first_line));
...
var_declaration : type_specifier declaration_list SEMICOLON {
	...
	| type_specifier ID LSQUARE RSQUARE ASSIGNOP LCURL argument_list RCURL SEMICOLON {
		string rule = "statement : type_specifier ID LSQUARE RSQUARE ASSIGNOP LCURL argument_list RCURL SEMICOLON";
		$$ = new ASTInternalNode(rule, @$.first_line, @$.last_line);
		$$->addChild($1)->addChild(new ASTLeafNode($2, @2.first_line))->addChild(new ASTLeafNode($3, @3.first_line))->addChild(new ASTLeafNode($4, @4.first_line))->addChild(new ASTLeafNode($5, @5.first_line))->addChild(new ASTLeafNode($6, @6.first_line))->addChild($7)->addChild(new ASTLeafNode($8, @8.first_line))->addChild(new ASTLeafNode($9, @9.first_line));
		writeLog("statement : type_specifier ID LSQUARE RSQUARE ASSIGNOP LCURL argument_list RCURL SEMICOLON ");
	}
;
...
declaration_list : declaration_list COMMA ID {
	...
	| declaration_list COMMA ID LSQUARE CONST_INT RSQUARE {
		...
		$$ = (new ASTVariableNode(rule, arrayInfo, @$.first_line, @$.last_line));
		if($1->isError()){
			$$->setError();
			$$->setRule("declaration_list : error");
			delete $1;
...
variable : ID {
		...
		$$ = new ASTVariableNode(rule, new VariableInfo($1->getName()), @$.first_line, @$.last_line);
		$$->addChild(new ASTLeafNode($1, @1.first_line));
